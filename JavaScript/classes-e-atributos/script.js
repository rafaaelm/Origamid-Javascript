...
const classeAtiva = document.querySelectorAll('.menu a');

classeAtiva.forEach ((item) => {
  item.classList.add('ativo')
});

// Remove a classe ativo de todos os itens do menu e mantenha apenas no primeiro

const classeAtiva = document.querySelectorAll('.menu');

classeAtiva.forEach((item) => {
  item.classList.remove('ativo')
});

classeAtiva[0].classList.add('ativo');
